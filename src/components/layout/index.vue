	...
	<a-layout id="layout-virgo-custom-trigger">
		...
		<a-layout>
			<a-layout-header style="background: #fff; padding: 0">
				<v-icon class="trigger" icon="indent-increase" type="" v-if="collapsed" @click="() => (collapsed = !collapsed)">
				</v-icon>
				<v-icon class="trigger" icon="indent-decrease" type="" v-else @click="() => (collapsed = !collapsed)"> </v-icon>
				<v-header></v-header>
			</a-layout-header>
			<v-tabs></v-tabs>
			<a-layout-content
